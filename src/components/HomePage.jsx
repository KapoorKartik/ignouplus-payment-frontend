      ...
      <div className='container-fluid bg-light'>
        <div className='row py-4'>
          <div className='col-md-12'>
            <div
              className='bg-white p-3 border  shadow-lg'
              ...
              <div className='row py-4'>
                <div className='col-md-6'>
                  <img
                    src='https://s3.ap-south-1.amazonaws.com/rzp-prod-merchant-assets/payment-link/description/blue%20yellow%20modern%20real%20estate%20mobile%20app%20promotion%20instagram%20post_nt4r3cmtqsbz4o.jpeg'
                    alt='Product'
                    className='img-thumbnail img-fluid w-100 mb-3'
                  />
                </div>
                ...
                <div className='row py-4'>
                  <div className='col-xs-12'>
                    ...
                    <iframe
                      width='100%'
                      height='315'
                      src='https://www.youtube.com/embed/XiH0XK646LE'
                      title='Video'
        ...
        <div
          className='bg-white p-3 border mb-3  shadow-lg'
          style={{ borderRadius: '20px' }}>
          <div className='row '>
            <div className='col-md-6'>
          ...
          <div className='row py-4'>
            <div className='col-md-6'>
              <div id='support-details'>
                ...
                <div className='sub-detail'>
                  <p>
                    You can easily get all terms and conditions at our official
                  ...
                  <p>
                    ...
                    PiWebTech (owner of this page) and Razorpay, adhering to
                    applicable laws.
                  </p>
                </div>
              </div>
